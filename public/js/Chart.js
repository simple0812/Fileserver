	...
	var Bar = function(data,config,ctx){
		...
		function drawScale(){
            ...
            if(data.customLabels)
                for (var i=0; i<data.datasets.length; i++){
                    ctx.textAlign = "center";
                    var barOffset = yAxisPosX + config.barValueSpacing  + barWidth*i + config.barDatasetSpacing*i + config.barStrokeWidth*i;
                    ctx.fillText(data.customLabels[i], barOffset + barWidth/2 , xAxisPosY + 10)
                }
